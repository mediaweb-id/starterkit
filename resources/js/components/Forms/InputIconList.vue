...
export default defineComponent({
  ...
  data() {
    return {
        ...
        formdata:{
                ...
                type: null,
                bg_color: null,
                btn_text:null, btn_url:null, btn_target:'_blank',
                cards:[{ title: null, summary: null,btn_text:null, btn_url:null, btn_target:'_blank'}],
            },
        default : [{ title: null, summary: null,btn_text:null, btn_url:null, btn_target:'_blank'}],
    };
  },
  created() {
  ...
  methods:{
    addRow(){
        this.$refs.tree.add({ title: null, summary: null,btn_text:null, btn_url:null, btn_target:'_blank' });
        this.save();
    },
    removeRow(stat){
  ...
  <div>
    <div class="block w-full overflow-x-auto mb-5">
        <div class="block">
            ...
            <InputSelect placeholder="Background Color" @change="save" v-model="formdata.bg_color" :options="colors" label="title" store="value"/>
        </div>
        <div class="block mt-4">
            <InputLabel class="text-left" for="button" value="Button" />
            <div class="flex gap-5">
                <TextInput class="!w-4/12" type="text"  placeholder="Button Text" v-model="formdata.btn_text"
                    @change="save" />
                <TextInput class="!w-4/12" type="text"  placeholder="Button Url" v-model="formdata.btn_url"
                    @change="save" />
                <InputSelect
                    class="!w-4/12"
                    placeholder="Button Target"
                    v-model="formdata.btn_target"
                    :options="targets"
                    label="title"
                    store="value"
                />
