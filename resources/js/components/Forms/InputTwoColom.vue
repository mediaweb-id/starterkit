  ...
  data() {
    return {
        ...
        formdata:{
                title: '',
                summary: '',
                cards:[{ title: null, summary: null, image: null, icon: null,  url:null}],
            },
        targets : [
...
<template>
  <div>
    ...
    <div class="flex w-full px-12">
        <SecondaryButton @click="addRow" type="button" class="justify-center "> <i class="fas text-white-400 mr-2 text-sm fa-plus"></i> Add New Colom</SecondaryButton>
    </div>
  </div>
</template>
<style>
