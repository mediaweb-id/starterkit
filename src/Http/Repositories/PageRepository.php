...
class PageRepository
{
    ...
    public function findByTemplate($template)
    {
        ...
        return Cache::tags(['pages'])->remember($cacheKey, Carbon::now()->addMonths(6), function () use ($template) {
            return Page::where('template',$template)->latest('created_at')->first();
        });
    }
